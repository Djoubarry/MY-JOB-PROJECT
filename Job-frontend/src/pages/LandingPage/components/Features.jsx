      ...
      <div className='container mx-auto px-4 relative z-10'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            Que vous cherchiez une nouvelle opportunité ou le candidat idéal,<br/>
            nous avons les outils et fonctionnalités pour y parvenir.
          </p>
        </div>
          ...
          <div>
            ...
            <div className='space-y-8'>
              {jobSeekerFeatures.map((feature, index) => (
                <div 
                  key={index} 
                  className='group flex items-start space-x-4 p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300 cursor-pointer'>
                  <div className='flex-shrink-0 w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center group-hover:bg-blue-200 transition-colors' >
                    <feature.icone className='w-6 h-6 text-blue-600' />
                  </div>
                  <div>
