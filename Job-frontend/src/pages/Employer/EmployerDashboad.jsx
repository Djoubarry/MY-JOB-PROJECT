...
const EmployerDashboad = () => {

  const navigate = useNavigate();

  // State pour stocker les données du tableau de bord
  ...
  const getDashboardOverView = async () => {
    try {
      ...
      console.log("Erreur lors de la récupération du tableau de bord", error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <DashboardLayout activeMenu='employer-dashbord'>
      {isLoading ? (
        <LoadingSpinner /> 
      ) : (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card 
              ...
              subtitle="Vos offres d’emploi les plus récentes"
              headerAction={
                <button
             ...
             <Card 
              ...
              subtitle="Les candidatures les plus récentes"
              headerAction={
                <button
                  className="text-sm text-blue-600 hover:text-blue-700 font-medium"
                  onClick={() => navigate("/manage-jobs")}
          ...
          <Card 
            ...
            subtitle="Tâches courantes pour bien démarrer"
          >
...
export default EmployerDashboad
