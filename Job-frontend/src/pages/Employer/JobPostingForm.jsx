...
const JobPostingForm = () => {
  ...
  return (
    <DashboardLayout activeMenu='post-job'>
      <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:py-6 '>
          ...
          <div className='bg-white shadow-xl rounded-2xl p-6'>
            ...
            <div className='space-y-6'>
              ...
              <InputField
                lable="Job Title"
                id="jobTitle"
                placeholder="e.g, Senior Frontend Developper"
